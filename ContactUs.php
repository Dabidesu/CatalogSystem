...
<body>
    <section class="text-center bg-light features-icons" style="background: #ffffff;height: 451.094px;">
        ...
        <h1 style="color: rgb(0,0,0);font-weight: bold;">CONTACT US</h1>
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><i class="icon-phone text-dark m-auto text-primary" data-bss-hover-animate="pulse" style="color: var(--bs-red);"></i></div>
                        <h3>Hotline Number</h3>
                        <p class="lead mb-0"></p>
                    </div>
                    <p class="lead mb-0" style="font-weight: bold;">09-372-8291 [NCR]</p>
                    <p class="lead mb-0" style="font-weight: bold;">09-402-3931 [OUTSIDE NCR]</p>
                </div>
                <div class="col-lg-4" style="background: #f5f5f5;height: 348.094px;">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><i class="icon-envelope-letter text-dark m-auto text-primary" data-bss-hover-animate="pulse"></i></div>
                        <h3>E-Mail</h3>
                        <p class="lead mb-0" style="font-weight: bold;">Agnoria_support@outlook.com [Support]</p>
                    </div>
                    <p class="lead mb-0" style="font-weight: bold;">Agnoria_business@outlook.com [Business-related]</p>
                </div>
                <div class="col-lg-4" style="background: #f5f5f5;">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><i class="icon-speech text-dark m-auto text-primary" data-bss-hover-animate="pulse"></i></div>
                        <h3>Social Media</h3>
                        <p class="lead mb-0" style="font-weight: bold;">AGNORIA.fb&nbsp;</p>
                    </div>
                    <p class="lead mb-0" style="font-weight: bold;">@AGNORIA</p>
                </div>
            </div>
        </div>
    </section>
