...
<body>
    <section class="text-center bg-light features-icons" style="background: #ffffff;height: 451.094px;">
        <nav class="navbar navbar-light navbar-expand-md navbar-fixed-top navigation-clean-button" style="background: rgb(34, 34, 34);border-radius: 20;border-top-left-radius: 20;border-top-right-radius: 20;border-bottom-right-radius: 20;border-bottom-left-radius: 20;border-style: none;padding-top: 0;padding-bottom: 10px;margin-top: -113px;margin-bottom: 33px;">
            <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <picture><img src="assets/img/agno_5.png" style="width: 59px;height: 54px;"></picture>
        ...
        <div class="container" style="height: 600.4px;">
            <section class="py-5 bg-light">
                <h1 class="text-center text-success" style="padding-top: 15px;padding-bottom: 15px;color: #1b6ce5!important;margin-top: 0px;">Frequently Asked Question</h1>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <div id="faqlist" class="accordion accordion-flush">
                                <div class="accordion-item">
                                    <h2 class="accordion-header"><button class="btn accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#content-accordion-1" style="--bs-danger-rgb: 95,207,255;">How to buy</button></h2>
                                    <div id="content-accordion-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                        <p class="accordion-body"> Go to the store catalog to browse the following products and click the item to view its detail before buying.</p>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header"><button class="btn accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#content-accordion-2">What are your payment methods</button></h2>
                                    <div id="content-accordion-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                        <p class="accordion-body"> You can pay with Mastercard, VISA, Paypal, Gcash and Credit card.</p>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header"><button class="btn accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#content-accordion-3">Couldn't find what you're looking for?</button></h2>
                                    <div id="content-accordion-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                        <p class="accordion-body"> You may contact us to check on the products that aren't listed on website for us to check the products you desire.'.</p>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header"><button class="btn accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#content-accordion-4">Do you have a mobile app?</button></h2>
                                    <div id="content-accordion-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                        <p class="accordion-body"> We have yet to develop a mobile app so for now you may access through the website.</p>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header"><button class="btn accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#content-accordion-5">I can't use the add to cart feature</button></h2>
                                    <div id="content-accordion-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                        <p class="accordion-body"> Registering and logging in to the website will allow you to access the Add to cart option.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="showcase">
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col">
                    <div class="x_001_laptop_main_wrap"></div>
                </div>
            </div>
            <div class="row g-0">
                <div class="col">
    ...
    <section class="text-center bg-light testimonials" style="height: 723px;margin-top: 88px;">
        <div class="container">
            <section>
                ...
                <div class="container-fluid">
                    <div class="row text-center">
                        <div class="col-12 col-sm-6 col-md-3">
                            ...
                            <picture><img src="assets/img/agno_5.png" style="width: 162px;height: 162px;"></picture>
                        </div>
