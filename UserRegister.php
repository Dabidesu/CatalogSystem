            ...
            <div class="row">
                <div class="col-md-6 col-xl-4">
                    <div class="login-card" style="height: 463.797px;"><img class="profile-img-card" src="assets/img/avatar_2x.png">
                        ...
                        <form class="form-signin" action="UserRegister.php" method="POST"><span class="reauth-email"> </span><input class="form-control" type="text" id="inputUsername" required="" placeholder="Username" autofocus="" name="username"><input class="form-control" type="password" id="inputPassword" required="" placeholder="Password" name="password">
                            <div class="checkbox"></div><button class="btn btn-primary btn-lg d-block btn-signin w-100" type="submit">Sign in</button>
                        </form><a class="forgot-password" href="UserLogin.php">Have an account? Login here</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <section id="carousel">
